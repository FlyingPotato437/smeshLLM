...
const AnimatedBackground: React.FC<AnimatedBackgroundProps> = ({ 
  className = "",
  dotColor = "rgba(140, 21, 21, 0.5)", // Stanford Cardinal Red
  opacity = 0.8
}) => {
  ...
  }, [dotColor, DOT_SPACING, GRID_CELL_SIZE, BASE_OPACITY_MIN, BASE_OPACITY_MAX, BASE_RADIUS]);
  ...
  const animateDots = useCallback(() => {
    ...
    dots.forEach((dot, index) => {
      ...
      const r = colorMatch ? colorMatch[1] : '140';
      const g = colorMatch ? colorMatch[2] : '21';
      const b = colorMatch ? colorMatch[3] : '21';
